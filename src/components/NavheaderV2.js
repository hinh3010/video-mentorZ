            ...
            <nav className="navigation scroll-bar" style={{ maxWidth: '280px' }}>
                <div className="container pl-0 pr-0">
                    <div className="nav-content">
                        ...
                        <div className="nav-caption fw-600 font-xssss text-grey-500" style={{
                        ...
                        <ul className="mb-3 menu-categories" >
                            ...
                            <li className='item-categoty'>
                                <NavLink
                                    ...
                                    data-tab="chats"
                                >
                                    {/* <i className="feather-tv mr-3 icon" ></i> */}
                                    <img src={icons.iconMonHoc} alt="icon" className='icon' />
                            ...
                            <li className='item-categoty'>
                                ...
                                >
                                    ...
                                    <img src={icons.iconTaiLieu} alt="icon" className='icon' />
                           ...
                           <li className='item-categoty'>
                                ...
                                >
                                    ...
                                    <img src={icons.iconThiTuDo} alt="icon" className='icon' />
                            ...
                            <li className="flex-lg-brackets item-categoty">
                                ...
                                >
                                    ...
                                    <img src={icons.iconConfession} alt="icon" className='icon' />
